...
StringLit : ( '"' ( StringLit_0 | EscapedChar )* '"' )
          | ( '\'' ( StringLit_1 | EscapedChar )* '\'' )
;
...
fragment Exponent: ('e' | 'E') ('+' | '-')? DigitString;
fragment L_0X : ( '0' | '0' ) ( 'X' | 'x' ) ;
fragment IdentifierPart : ID_Continue | Sc ;
fragment EscapedSymbolicName_0 : [\u0000-_a-\uFFFF] ;
fragment IdentifierStart : ID_Start;
fragment Sc : [$\u00A2-\u00A5\u058F\u060B\u09F2-\u09F3\u09FB\u0AF1\u0BF9\u0E3F\u17DB\u20A0-\u20BA\uA838\uFDFC\uFE69\uFF04\uFFE0-\uFFE1\uFFE5-\uFFE6] ;
...
fragment SPACE : [ ] ;
fragment TAB : [\t] ;
fragment StringLit_0 : [\u0000-!#-\[\]-\uFFFF] ;
fragment StringLit_1 : [\u0000-&(-\[\]-\uFFFF] ;
fragment LF : [\n] ;
fragment VT : [\u000B] ;
fragment US : [\u001F] ;
fragment GS : [\u001D] ;
